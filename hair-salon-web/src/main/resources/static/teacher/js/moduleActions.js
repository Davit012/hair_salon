...
function updateListeners(addModuleButton) {
    addModuleButton.addEventListener("click", function () {
        ...
        var id = addModuleButton.getAttribute("id");
        let duration = document.getElementById("lessonDuration" + id).textContent;
        ...
        img.src = "/teacher/img/icons/lines.png";
        input.type = "text";
        input.name = "lessons[]";
        ...
        moduleName.className = "mx-2 px-1";
        moduleRange.textContent = duration;
