...
/* ----------------------------- Colors function ---------------------------- */
var themeControlCheckbox = document.getElementById('themeControlToggle');
var studentBlock = document.querySelector('.student-block');
if(themeControlCheckbox !== null && studentBlock !== null) {
  themeControlCheckbox.addEventListener('click', function (event){
      if(this.checked){
          studentBlock.classList.remove('test');
      } else {
        studentBlock.classList.add('test');
      }
  });
}
